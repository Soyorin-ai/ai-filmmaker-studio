...
export const WORKFLOW_TEMPLATES: WorkflowTemplate[] = [
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        data: { label: '生成视频', genType: 'text2video', resolution: '720p', duration: 5, generateAudio: false } as Partial<VideoGenNodeData>,
      },
      {
        id: 'output-1',
        type: 'output',
  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        data: { label: '场景1视频', genType: 'image2video', resolution: '720p', duration: 5, generateAudio: false } as Partial<VideoGenNodeData>,
      },
      {
        id: 'video-2',
        type: 'videoGen',
        position: { x: 600, y: 300 },
        data: { label: '场景2视频', genType: 'image2video', resolution: '720p', duration: 5, generateAudio: false } as Partial<VideoGenNodeData>,
      },
      {
        id: 'merge-1',
        type: 'merge',
  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        data: { label: '生成视频', genType: 'text2video', resolution: '720p', duration: 10, generateAudio: false } as Partial<VideoGenNodeData>,
      },
      {
        id: 'music-1',
        type: 'musicGen',
