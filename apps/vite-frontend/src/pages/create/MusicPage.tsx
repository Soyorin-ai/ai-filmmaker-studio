...
// 风格标签
const STYLE_TAGS = [
  'pop', 'rock', 'jazz', 'electronic', 'lo-fi', 'cinematic',
  'ballad', 'upbeat', 'emotional', 'romantic', 'energetic', 'calm',
  'female vocals', 'male vocals', 'acoustic', 'orchestral',
];
            ...
            >
              <Tabs value={activeTab} onValueChange={setActiveTab}>
                <TabsList className="grid w-full grid-cols-3 bg-white/5 border border-white/10 rounded-xl p-1">
                  <TabsTrigger value="simple" className="data-[state=active]:bg-white/10 data-[state=active]:text-white text-white/60 rounded-lg">简单模式</TabsTrigger>
                  <TabsTrigger value="custom" className="data-[state=active]:bg-white/10 data-[state=active]:text-white text-white/60 rounded-lg">自定义歌词</TabsTrigger>
                  <TabsTrigger value="instrumental" className="data-[state=active]:bg-white/10 data-[state=active]:text-white text-white/60 rounded-lg">纯音乐</TabsTrigger>
                </TabsList>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="mt-6 space-y-6">
                      ...
                      <div>
                        ...
                        >
                          ...
                          <SelectContent className="bg-slate-900 border-white/20">
                            <SelectItem value="f" className="hover:bg-white/10">女声</SelectItem>
                            <SelectItem value="m" className="hover:bg-white/10">男声</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-4 border-t border-white/10">
                    <div>
                      ...
                      <Select
                        value={watchedModel}
                        onValueChange={(v) => setValue('model', v as any)}
                      >
                        <SelectTrigger className="mt-2 bg-white/5 border-white/10 text-white">
                          <SelectValue />
                        </SelectTrigger>
          ...
          <div className="lg:col-span-2 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  {generatedMusic.status === 'failed' && (
                    <div className="text-red-400">
                      生成失败: {generatedMusic.error || '未知错误'}
                    </div>
                  )}
                </div>
              ) : (
            ...
            >
              ...
              <ul className="space-y-2 text-sm text-white/50">
                <li>• <strong>简单模式</strong>：描述你想要的音乐，AI 自动生成歌词</li>
                <li>• <strong>自定义歌词</strong>：自己写歌词，AI 为你谱曲演唱</li>
                <li>• <strong>纯音乐</strong>：生成无歌词的背景音乐</li>
