...
export class ProjectsController {
  ...
  async addAsset(@Param('id') id: string, @Param('assetId') assetId: string, @CurrentUser() user: JwtPayload) {
  ...
  async removeAsset(@Param('id') id: string, @Param('assetId') assetId: string, @CurrentUser() user: JwtPayload) {
