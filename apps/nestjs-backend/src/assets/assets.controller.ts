...
export class AssetsController {
  ...
  async removeMany(@Body('ids', new ParseArrayPipe({items: String})) ids: string[], @CurrentUser() user: JwtPayload) {
  ...
  async update(@Param('id') id: string, @Body() dto: UpdateAssetDto, @CurrentUser() user: JwtPayload) {
  ...
  async addTag(@Param('id') id: string, @Body('tag') tag: string, @CurrentUser() user: JwtPayload) {
  ...
  async removeTag(@Param('id') id: string, @Param('tag') tag: string, @CurrentUser() user: JwtPayload) {
